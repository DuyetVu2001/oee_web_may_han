...
const GrafanaOperate = ({ visible, setVisible, input = "" }) => {
    ...
    return <div style={{ position: 'relative', width: '100vw', height: '100vh', overflowY: 'scroll' }}>
        ...
        <iframe
            src={`https://dashboard.quantrisanxuat.info/d/sfu7SUBnk/employee?orgId=2&theme=light&theme=light&from=${timestamp.from}&to=${timestamp.to}&var-ENTERPRISE=${User.enterprise_id}&var-AREA=${area}&var-LINE=${line}&var-MACHINE=${machine}&var-PRODUCT=${product}&kiosk`}
            width="100%"
            height="100%"
            frameBorder="0"
