...
export const get = (params) => apiClient.get('/notification/daily', params)
export const post = (body) => apiClient.post('/notification/daily', body)
export const patch = (body) => apiClient.patch('/notification/daily', body)
export const deleteMany = (params) => apiClient.delete('notification/daily', params)
