...
const TableFunction = (props) => {
    ...
    const _handleChangeDetail = (val) => {
        ...
        setShowDetail(prev => {
            ...
            console.log("dataCV" , dataConvert);
        ...
        <div style={{}}>
            ...
            >
                <TableCustom
                    ...
                    // onRow={(r) => ({ onClick: () => {
                    //     if(userrole != 1 ) {
                    //         alert("You don't have permission to edit notification")
                    //         return 0;
                    //     }
                    //     console.log("r" ,r);
                    //     const dataConvert = r.machine_id.split(',').map(i => i.trim())
                    //     setShowDetail({ data: {
                    //         ...r,
                    //         machine_id : dataConvert
                    //     }, type: "EDIT" }) }
                    // })}
                />
                <Pagination
            ...
            <ModalFormDetail
                ...
                _changeDetail={_handleChangeDetail}
            />
            {/* <FilterForm
