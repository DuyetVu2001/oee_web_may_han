...
export const get = (params) => apiClient.get('/notification/user', params)
export const post = (body) => apiClient.post(ENDPOINT, body)
export const patch = (body) => apiClient.patch('/notification', body)
export const deleteMany = (params) => apiClient.delete('/notification/user', params)
