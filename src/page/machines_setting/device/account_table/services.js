...
export const get = (body) => axios.get(`${TEST_HOST}/machines/net-setting`, body);
export const post = (body) => axios.post(`${TEST_HOST}/machines/net-setting`, body);
export const patch = (body) => axios.put(`${TEST_HOST}/machines/net-setting`, body);
