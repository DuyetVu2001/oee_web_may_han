...
import { HomeOutlined, UserOutlined, RetweetOutlined, SettingOutlined } from '@ant-design/icons';
import { Drawer, Breadcrumb, Menu, Popover, Tabs, Input, Button } from 'antd';
...
export const LIST_PAGE = ['View_1', 'View_2', 'View_3'];
// 
const App = () => {
