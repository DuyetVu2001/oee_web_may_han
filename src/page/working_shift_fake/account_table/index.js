...
const TableFunction = (props) => {
    ...
    const _handleDel = (body) => requestDel({id : selectedRow} , dispatchTable)
    const _handleAddNew = (body) => requestAddNew(body, dispatchTable , () => setShowAddNew(false))
    const _handleUpdate = (body) => requestEdit(body, dispatchTable , () => setShowDetail(false))
