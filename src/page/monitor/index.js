...
export default function MonitorPage() {
	...
	useEffect(() => {
		...
		// axios.get(`${TEST_HOST}/machines/${machineId}`).then((res) => {
		// 	const machines = res.data;
		// 	setMachinesDetail(machines);
		// });
	}, [query]);
		...
		<InApp>
			<div style={{ marginTop: 6 }}>
				...
				<div style={{ marginBottom: 22, display: 'flex' }}>
					...
					<Tag label="Power consumed" value="100kw" />
					<Tag label="Wire velocity" value="100" color={TAG_COLORS[0]} />
					<Tag label="Wire consumed" value="100" color="orange" />
				</div>
